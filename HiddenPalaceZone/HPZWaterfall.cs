...
namespace FP2_Knux_Objects.HiddenPalaceZone
{
    public class HPZWaterfall : FPBaseObject
    {
        ...
        private new void Start()
        {
            ...
            // If any of the segments are null, the throw an error, destroy the template object then abort.
            if (topSegment == null || middleSegment == null || bottomSegment == null)
            {
                Plugin.consoleLog.LogError("Template Waterfall pieces weren't found in the scene!");
